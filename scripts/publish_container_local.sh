...
usage() {
  cat <<'EOF'
Usage:
  bash scripts/publish_container_local.sh [--version 0.6.11] [--registry ddns.cellnucle.us:3333] [--namespace hugo] [--image-name cageledger] [--base-image-name cageledger-base] [--export-offline-images] [--skip-base-sync]
