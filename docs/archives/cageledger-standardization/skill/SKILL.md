# cageledger-standardization-dev（历史归档）

> 2026-09-12 归档自 `.codex-run/skills/cageledger-standardization-dev/SKILL.md`。以下为 v0.5.3 阶段的历史指令，保留用于追溯，不作为当前任务入口、技术约束或待办。当前规则见仓库根目录 `AGENTS.md` 与 `docs/contracts/`。
