...
<tr style="height:4.86mm"><td class="label">接收人员：</td><td class="value" colspan="2">${escapeHtml(batch.receiverName)}</td><td class="label" colspan="2">联系电话：</td><td class="value" colspan="3">${escapeHtml(batch.vetPhone)}</td></tr>
